...
(function e(t, n, r) {
        ...
        function (require, module, exports) {
            ...
            function createElemClass(type, renderFunc) {
                function update(options) {
                    ...
                    var children = this.children, root = this.root, type = this.type;
                    extend(this.attrs, options, true);
    ...
    5: [
        function (require, module, exports) {
            /*@require ./rosetta.css*/
            /**Rosetta v1.0,0**/
            var supportEvent = require('./supportEvent.js'), utils = require('./utils.js'), query = utils.query, toType = utils.toType, objToString = utils.objToString, extend = utils.extend, toPlainArray = utils.toPlainArray, isOriginalTag = utils.isOriginalTag, isDomNode = utils.isDomNode, isString = utils.isString, isFunction = utils.isFunction, bind = utils.bind, fire = utils.fire, _refers = {}, _elemClass = {}, allRendered = false, lifeEvents = require('./lifeEvents.js'), ATTACHED = lifeEvents.ATTACHED, DETACHED = lifeEvents.DETACHED, CREATED = lifeEvents.CREATED;
            ATTRIBUTECHANGE = lifeEvents.ATTRIBUTECHANGE;
            ...
            function init() {
                ...
                for (var i = 0; i < elems.length; i++) {
                    var item = elems[i], type = item.tagName.toLowerCase(), attrs = item.attributes, options = {};
                    if (type.indexOf('r-') == 0) {
            ...
            function create(type, attr) {
                var children = [].slice.call(arguments, 2), children = toPlainArray(children), result = null;
                attr = attr || {};
                if (isString(type)) {
                    if (isOriginalTag(type)) {
                        ...
                        var NewClass = getElemClass(type), elemObj = null;
                        if (!NewClass) {
                            return;
                        }
