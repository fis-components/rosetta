...
*/
    ...
    4: [
        function (require, module, exports) {
            /*@require ./rosetta.css*/
            var supportEvent = require('./supportEvent.js'), utils = require('./utils.js'), query = utils.query, toType = utils.toType, objToString = utils.objToString, extend = utils.extend, toPlainArray = utils.toPlainArray, isOriginalTag = utils.isOriginalTag, isDomNode = utils.isDomNode, isString = utils.isString, isFunction = utils.isFunction, ATTACHED = 'attached', DETACHED = 'detached', CREATED = 'created', ATTRIBUTECHANGE = 'attributeChange', refers = {}, _elemClass = {}, allRendered = false;
            ...
            function createElemClass(type, renderFunc) {
                function update(options) {
                    ...
                    var children = this.children, attrs = this.root.attributes, root = this.root, type = this.type, attr = {};
    ...
    6: [
        function (require, module, exports) {
            ...
            extend = module.exports.extend = function (target) {
                ...
                case 'object':
                    var indent = Array(indeep || 1).join('\t'), isArray = Array.isArray(obj);
    ...
    7: [
        function (require, module, exports) {
            var es5shim = require('./lib/es5-shim.js'), ieshim = require('./lib/ie-shim.js'), Rosetta = require('./lib/rosetta.js'), readyRE = /complete/, ready = function (callback) {
